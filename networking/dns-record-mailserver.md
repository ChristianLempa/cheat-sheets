...
If you want to run a mail server on the public internet, you need to set up your DNS records correctly. While some [[dns-record-types|DNS Records]] are necessary to send and receive emails, others are recommended to build a good reputation.
...
>If you want to add DKIM to your mail server you first need to create a [[create-dkim-keypair|private and public keypair]]
 
**Recommended Settings:**
