...
For a complete list of HTML entities with their numbers and names along with a full list of ASCII characters that can be represented in HTML, see the [HTML Char](html-char) cheat sheet.
