# Argo CD
**Argo CD** is a declarative, GitOps continuous delivery tool for **[Kubernetes](../kubernetes/kubernetes)**. It allows application definitions, configurations, and environments should be declarative and version controlled. Application deployment and lifecycle management should be automated, auditable, and easy to understand.
...
1. Install Argo CD on a **[Kubernetes](../kubernetes/kubernetes)** Cluster, using **[kubectl](../kubernetes/kubectl)**.
