...
W3Techs reports that, as of October 2022, "PHP is used by 74.4% of all the websites whose server-side programming language we know.
...
```
See: [Regex in PHP](../linux/regex.md#regex-in-php)
